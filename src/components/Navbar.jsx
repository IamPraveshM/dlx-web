...
export default function Navbar() {
  ...
  useEffect(() => {
    // Only animate when we have links loaded
    if (loading) return; 
      ...
      <style>{`
        * {
        ...
        .mobile-menu {
          ...
          transition: transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1);
          animation: ${isMenuOpen ? "slideInRight 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)" : "none"};
        }
        .mobile-menu::before {
          content: '';
          position: absolute;
        ...
        .mobile-cta {
          ...
          position: relative;
          overflow: hidden;
          animation: ${isMenuOpen ? "scaleIn 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) 0.2s both" : "none"};
        }
        .mobile-cta::before {
          content: '';
          position: absolute;
        ...
        @media (max-width: 1024px) {
          .navbar-container { padding: 14px 32px; }
        }
      ...
      <nav className="navbar" ref={navbarRef}>
        <div className="navbar-container">
          ...
          <div className="nav-actions">
            ...
            >
              <span className={`hamburger-line line-top ${isMenuOpen ? "open" : ""}`} />
              <span className={`hamburger-line line-middle ${isMenuOpen ? "open" : ""}`} />
              <span className={`hamburger-line line-bottom ${isMenuOpen ? "open" : ""}`} />
            </button>
          </div>
        </div>
      </nav>
